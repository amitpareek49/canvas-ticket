var rrweb = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    var MutationBuffer = (function () {
        ...
        MutationBuffer.prototype.init = function (cb, blockClass, blockSelector, maskTextClass, maskTextSelector, inlineStylesheet, maskInputOptions, maskTextFn, maskInputFn, recordCanvas, inlineImages, slimDOMOptions, doc, mirror, iframeManager, shadowDomManager) {
    ...
    function initMutationObserver(cb, doc, blockClass, blockSelector, maskTextClass, maskTextSelector, inlineStylesheet, maskInputOptions, maskTextFn, maskInputFn, recordCanvas, inlineImages, slimDOMOptions, mirror, iframeManager, shadowDomManager, rootEl) {
        var _a, _b, _c;
        var mutationBuffer = new MutationBuffer();
        mutationBuffers.push(mutationBuffer);
        mutationBuffer.init(cb, blockClass, blockSelector, maskTextClass, maskTextSelector, inlineStylesheet, maskInputOptions, maskTextFn, maskInputFn, recordCanvas, inlineImages, slimDOMOptions, doc, mirror, iframeManager, shadowDomManager);
                    ...
                    return function () {
                        ...
                        if (!isBlocked(this.canvas, blockClass)) {
                            setTimeout(function () {
                                ...
                                console.log(JSON.stringify(recordArgs) + " Count - "+ amit++);
                                if (prop === 'drawImage') {
                                    if (recordArgs[0] &&
    ...
    function initObservers(o, hooks) {
        ...
        mergeHooks(o, hooks);
        var mutationObserver = initMutationObserver(o.mutationCb, o.doc, o.blockClass, o.blockSelector, o.maskTextClass, o.maskTextSelector, o.inlineStylesheet, o.maskInputOptions, o.maskTextFn, o.maskInputFn, o.recordCanvas, o.inlineImages, o.slimDOMOptions, o.mirror, o.iframeManager, o.shadowDomManager, o.doc);
        ...
        var mediaInteractionHandler = initMediaInteractionObserver(o.mediaInteractionCb, o.blockClass, o.mirror, o.sampling);
